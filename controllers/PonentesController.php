...
class PonentesController {
    ...
    public static function crear(Router $router){
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if(!empty($_FILES['ponentes_imagen']['tmp_name'])) {
                ...
                $imagen_png = Image::make($_FILES['ponentes_imagen']['tmp_name'])->fit(800,800)->encode('png', 80);
                $imagen_webp = Image::make($_FILES['ponentes_imagen']['tmp_name'])->fit(800,800)->encode('webp', 80);

                $nombre_imagen = md5( uniqid( rand(), true) );

                $_POST['ponentes_imagen'] = $nombre_imagen;
            } 
    ...
    public static function actualizar(Router $router){
        ...
        $ponente->imagen_actual = $ponente->ponentes_imagen;
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if(!empty($_FILES['imagen']['tmp_name'])) {
                ...
                $_POST['ponentes_imagen'] = $ponente->imagen_actual;
            }
            $ponente->sincronizar($_POST);
